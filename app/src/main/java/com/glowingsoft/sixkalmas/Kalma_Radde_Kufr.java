...
public class Kalma_Radde_Kufr extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kalma__radde__kufr);

        back = (ImageView) findViewById(R.id.back);


        play =(Button) findViewById(R.id.play_btn);
        final MediaPlayer mp = MediaPlayer.create(Kalma_Radde_Kufr.this,R.raw.sixk);
        ...
        kalma= (TextView) findViewById(R.id.kalma_radde_kufr);
