...
public class Kalma_Tawhid extends AppCompatActivity {
   ...
   private Button play,share;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kalma__tawhid);
        back = (ImageView) findViewById(R.id.back);


        play =(Button) findViewById(R.id.play_btn);
        final MediaPlayer mp = MediaPlayer.create(Kalma_Tawhid.this,R.raw.fourthk);
        ...
        kalma= (TextView) findViewById(R.id.kalma_tawhid);
