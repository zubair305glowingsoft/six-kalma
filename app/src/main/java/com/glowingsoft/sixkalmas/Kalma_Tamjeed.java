...
public class Kalma_Tamjeed extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kalma__tamjeed);

        back = (ImageView) findViewById(R.id.back);


        play =(Button) findViewById(R.id.play_btn);
        final MediaPlayer mp = MediaPlayer.create(Kalma_Tamjeed.this,R.raw.thirdk);
        ...
        kalma= (TextView) findViewById(R.id.kalma_tamjeed);
