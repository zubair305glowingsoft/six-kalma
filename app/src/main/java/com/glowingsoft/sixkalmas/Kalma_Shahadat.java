...
public class Kalma_Shahadat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kalma__shahadat);
        back = (ImageView) findViewById(R.id.back);


        play =(Button) findViewById(R.id.play_btn);
        final MediaPlayer mp = MediaPlayer.create(Kalma_Shahadat.this,R.raw.secondk);
        ...
        kalma= (TextView) findViewById(R.id.kalma_shahadat);
