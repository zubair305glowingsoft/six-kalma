...
public class Kalma_tayyba extends AppCompatActivity {
   private ImageView back;
   private Button play,share;
   private TextView kalma_name,kalma_tayyba,kalma_urdu_trns,kalma_english_trns;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_kalma_tayyba);
        back =(ImageView) findViewById(R.id.back);

        play =(Button) findViewById(R.id.play_btn);
        final MediaPlayer mp = MediaPlayer.create(Kalma_tayyba.this,R.raw.istk);
        ...
        kalma_tayyba= (TextView) findViewById(R.id.kalma_tayyba);
        ...
        final String kal_1 = kalma_tayyba.getText().toString().trim();
